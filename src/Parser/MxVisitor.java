...
public interface MxVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code otherFn}
	 * labeled alternative in {@link MxParser#funcDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOtherFn(MxParser.OtherFnContext ctx);
	/**
	 * Visit a parse tree produced by the {@code constructFn}
	 * labeled alternative in {@link MxParser#funcDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructFn(MxParser.ConstructFnContext ctx);
	/**
	 * Visit a parse tree produced by the {@code mainFn}
	 * labeled alternative in {@link MxParser#funcDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the {@code classMethodCallExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassMethodCallExpr(MxParser.ClassMethodCallExprContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitArrayElementExpr(MxParser.ArrayElementExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code newArrayDefExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNewArrayDefExpr(MxParser.NewArrayDefExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code errorArrayDefExpr}
	 * labeled alternative in {@link MxParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitErrorArrayDefExpr(MxParser.ErrorArrayDefExprContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link MxParser#defination}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDefination(MxParser.DefinationContext ctx);
	/**
